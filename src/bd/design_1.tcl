...
digilentvhdlclub:user:axi_pwm_generator:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set led_blue [ create_bd_port -dir O -from 0 -to 0 led_blue ]
  set led_green [ create_bd_port -dir O -from 0 -to 0 led_green ]
  set led_red [ create_bd_port -dir O -from 0 -to 0 led_red ]
  ...
  set pwm_blue [ create_bd_cell -type ip -vlnv digilentvhdlclub:user:axi_pwm_generator:1.0 pwm_blue ]

  # Create instance: pwm_green, and set properties
  set pwm_green [ create_bd_cell -type ip -vlnv digilentvhdlclub:user:axi_pwm_generator:1.0 pwm_green ]

  # Create instance: pwm_red, and set properties
  set pwm_red [ create_bd_cell -type ip -vlnv digilentvhdlclub:user:axi_pwm_generator:1.0 pwm_red ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins pwm_red/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M02_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins pwm_blue/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins pwm_green/S00_AXI]

  # Create port connections
  connect_bd_net -net axi_pwm_generator_0_pwm_out [get_bd_ports led_red] [get_bd_pins pwm_red/pwm_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pwm_blue/s00_axi_aclk] [get_bd_pins pwm_green/s00_axi_aclk] [get_bd_pins pwm_red/s00_axi_aclk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net pwm_blue_pwm_out [get_bd_ports led_blue] [get_bd_pins pwm_blue/pwm_out]
  connect_bd_net -net pwm_green_pwm_out [get_bd_ports led_green] [get_bd_pins pwm_green/pwm_out]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pwm_blue/s00_axi_aresetn] [get_bd_pins pwm_green/s00_axi_aresetn] [get_bd_pins pwm_red/s00_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_red/S00_AXI/S00_AXI_reg] SEG_axi_pwm_generator_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_blue/S00_AXI/S00_AXI_reg] SEG_pwm_blue_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_green/S00_AXI/S00_AXI_reg] SEG_pwm_green_S00_AXI_reg
